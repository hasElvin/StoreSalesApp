...
public class Store {
    ...
    public static void main(String[] args) {
        ...
        storeProducts.add(new ArtObject("Oil Painting", 1350, "Painted in 1950"));
        storeProducts.add(new ArtObject("Sculpture", 2000, "Work by JFK in 1951"));

        storeProducts.add(new Furniture("Desk", 500, "Mahogany Desk"));
        storeProducts.add(new Furniture("Lamp", 200, "Tiffany Lamps"));
